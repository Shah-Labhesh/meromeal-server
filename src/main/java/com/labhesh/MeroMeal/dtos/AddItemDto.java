...
public class AddItemDto {
    ...
    @NotBlank(message = "SubCategory id must not be empty")
    // uuid
    @Pattern(regexp = "^[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[89ab][a-f0-9]{3}-[a-f0-9]{12}$", message = "SubCategory id must be valid")
